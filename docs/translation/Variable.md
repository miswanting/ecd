...
欲了解更多信息，请参见[用户自定义变量](Custom_Variable)。
...
|        变量名         |  类型  | 维度 | 赋值 | 可保存 | 禁用 |                   默认值                    |             初始化时机             |                             备注                             |
| :-------------------: | :----: | :--: | :--: | :----: | :--: | :-----------------------------------------: | :--------------------------------: | :----------------------------------------------------------: |
